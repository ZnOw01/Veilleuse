...
var en = {
  ...
  periodDay: 'Schedule: day',
  periodNight: 'Schedule: night',
  ...
  appliedPresetLabel: 'Applied now',
  ...
  working: 'Applying…',
  keyboardHints: 'j/k move · h/l switch view · Enter activate · Esc close',
  minutesShort: 'min',
  ...
  scopeHelp: 'Session: applies until you log out. Persistent: survives reboots.',
  preflightOk: 'OK',
...
var ALIASES = {
  ...
  preset_day: 'presetDay', preset_evening: 'presetEvening', preset_night: 'presetNight',
  ...
  live_controls: 'liveControls', view_history: 'viewHistory', latest_event: 'latestEvent',
  new_preset_name: 'newPresetName', delete_preset_confirm: 'deletePresetConfirm',
  reload_presets: 'reloadPresets', schedule_runs: 'scheduleRuns',
  snooze_active: 'snoozeStatusActive', minutes_short: 'minutesShort', working: 'working',
  keyboard_hints: 'keyboardHints', applied_preset: 'appliedPresetLabel',
  ...
  scope_help: 'scopeHelp', preflight_ok: 'preflightOk', preflight_failed: 'preflightFailed',
